...
public class MainActivity extends Activity
    ...
    private void getResultsFromApi() {
        if (! isGooglePlayServicesAvailable()) {
            ...
            MakeRequestTask haha = new MakeRequestTask(mCredential);
            haha.execute();
    ...
    public class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        protected List<String> doInBackground(Void... params) {
            ...
            try {
                ...
                lul.add(getDataFromApi().get(8));
                lul.add(getDataFromApi().get(9));
                lul.add(getDataFromApi().get(10));
                lul.add(getDataFromApi().get(11));
                ArrayList<String> lul3 = listMessagesWithLabels( 10);
                ArrayList<String> lul7 = getContent();
                // ArrayList<String> lul2 = listMessagesWithLabels( 9);
                //  ArrayList<String> lul1 = listMessagesWithLabels( 8);
                //  ArrayList<String> lul4 = listMessagesWithLabels( 11);
                intent.putStringArrayListExtra("list_label", lul);
                intent.putStringArrayListExtra("inbox", lul3);
                intent.putStringArrayListExtra("content", lul7);
                // intent.putStringArrayListExtra("send", lul2);
                // intent.putStringArrayListExtra("trash", lul4);
                // intent.putStringArrayListExtra("chat", lul1);
